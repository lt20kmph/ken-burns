...
instance Yesod App where
    ...
    errorHandler (InternalError msg) = fmap toTypedContent $ defaultLayout $ do
            setTitle "Arrrg!"
            toWidget [hamlet|
              ...
              <div .centered-container>
                <p>#{msg}
              <div .centered-container>
                <i .fa.fa-frown-o.hugeText>
              <div .centered-container>
                <h2> Ouch! That hurt, please stop poking me!
                  |]
    ...
    -- isAuthorized UploadFileR _ = pure Authorized
...
instance YesodBreadcrumbs App where
    ...
    breadcrumb UploadFileR = return ("Home", Nothing)
